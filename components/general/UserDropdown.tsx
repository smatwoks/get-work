        ...
        <DropdownMenu >
            ...
            <DropdownMenuContent className="w-48" align="end">
                <DropdownMenuLabel className="flex flex-col">
                    ...
                    <span className="textx-xs text-muted-foreground">{email}</span>
                ...
                <DropdownMenuSeparator />
                    <DropdownMenuItem asChild>
                        <form action={async()=>{
                            ...
                            <button className="flex w-full items-center gap-2"><LogOut size={16} strokeWidth={2} className="opacity-60"/>
                            <span>Logout</span>
                            </button>
                        </form>
                    </DropdownMenuItem>
